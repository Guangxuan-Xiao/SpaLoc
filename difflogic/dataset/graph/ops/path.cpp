...
vector<vector<int64_t>> find_all_paths(
    torch::Tensor rowptr,
    torch::Tensor col,
    int64_t start,
    int64_t end,
...
set<int64_t> dfs_find_all_path_nodes(
    torch::Tensor rowptr,
    torch::Tensor col,
    int64_t start,
    int64_t end,
...
set<int64_t> bfs_find_all_path_nodes(
    torch::Tensor rowptr,
    torch::Tensor col,
    int64_t start,
    int64_t end,
